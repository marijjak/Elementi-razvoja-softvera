    ...
    public class ProdajaServis : IProdajaServis
    {
        ...
        public bool PokusajDobaviRacuneZaDan(Korisnik korisnik, DateTime datum, out List<FiskalniRacun> racuniZaDan)
        {
            ...
            try
            {
                ...
                _logger.EvidentirajDogadjaj(TipEvidencije.INFO, $"Uspešno dobavljeni računi za datum {datum.ToShortDateString()}.");
                return true;
            }
            catch
            {
                _logger.EvidentirajDogadjaj(TipEvidencije.ERROR, "Sistemska greška pri filtriranju računa.");
                return false;
            }
        }
